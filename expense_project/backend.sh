...
cp -r /home/ec2-user/shell_final/expense_project /etc/systemd/system/backend.service &>>$logname

dnf install mysql -y &>>$logname
validate $? "installing mysql schema"

mysql -h mysql.myfooddy.fun -uroot -pExpenseApp@1 < /home/ec2-user/shell_final/expense_project/schema/backend.sql &>>$logname
